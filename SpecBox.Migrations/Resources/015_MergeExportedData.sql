...
BEGIN
    ...
    INSERT INTO tmp_group (featureId, featureCode, title, "order")
    SELECT f."Id", ea."FeatureCode", ea."GroupTitle", ea."GroupOrder"
    ...
    GROUP BY f."Id", ea."FeatureCode", ea."GroupTitle", ea."GroupOrder";
    ...
    WHEN MATCHED THEN
        ...
        SET "Order" = t."order"
    WHEN NOT MATCHED THEN
        INSERT ("FeatureId", "Title", "Order")
        VALUES (t.featureId, t.title, t."order");
    ...
    INSERT INTO tmp_assertion (groupId, title, description, isAutomated, "order")
    SELECT gr."Id", ea."Title", ea."Description", ea."IsAutomated", ea."AssertionOrder"
    FROM public."ExportAssertion" ea
    ...
    WHEN MATCHED THEN
        ...
        SET "Description" = t.description,
            ...
            "Order" = t."order"
    WHEN NOT MATCHED THEN
        INSERT ("AssertionGroupId", "Title", "Description", "IsAutomated", "Order")
        VALUES (t.groupId, t.title, t.description, t.isAutomated, t."order");
